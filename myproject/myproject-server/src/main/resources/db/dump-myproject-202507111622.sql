...
INSERT INTO `sys_menu` VALUES (1,'用户管理','admin','M',1,0,'/admin','admin/Admin',NULL),(2,'文章管理','article','M',2,0,'/admin','admin/Admin',NULL),(1001,'用户列表','test:001','C',1,1,'/admin/user/userList','admin/UserListView','User'),(1002,'角色列表','confirm:002','C',2,1,'/admin/user/roleList','admin/RoleListView','Role'),(1003,'菜单列表','test:002','C',3,1,'/admin/user/menuList','admin/MenuListView','Menu'),(2001,'标签列表','tag','C',1,2,'/admin/article/tagList','article/ArticleTagsView','Tags');
...
INSERT INTO `sys_role_menu` VALUES (1,1),(1,1001),(1,1002),(1,1003);
...
-- Dump completed on 2025-07-11 16:22:04
